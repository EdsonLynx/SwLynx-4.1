...
Public Class DocumentEventHandler
    ...
    Overridable Function Init(ByVal sw As SldWorks, ByVal addin As SwAddin, ByVal SwModel As ModelDoc2) As Boolean
    End Function
...
Public Class PartEventHandler
    ...
    Overrides Function Init(ByVal sw As SldWorks, ByVal addin As SwAddin, ByVal SwModel As ModelDoc2) As Boolean
        userAddin = addin
        iPart = SwModel
        iDocument = iPart
        iSwApp = sw
...
Public Class AssemblyEventHandler
    ...
    Protected Function ComponentStateChange(ByVal componentModel As Object, Optional ByVal newCompState As Short = swComponentSuppressionState_e.swComponentResolved) As Integer
        ...
        Select Case newState
            ...
            Case swComponentSuppressionState_e.swComponentFullyResolved, swComponentSuppressionState_e.swComponentResolved
                ...
                If ((Not swModel Is Nothing) AndAlso Not Me.swAddin.OpenDocumentsTable.Contains(swModel)) Then
                    Me.swAddin.AttachModelDocEventHandler(swModel)
                End If
    ...
    Public Function AssemblyDoc_ComponentVisiblePropertiesChangeNotify(ByVal swObject As Object) As Integer
        ...
        swModel = component.GetModelDoc

        Return ComponentStateChange(swModel)
